...
from src.models.repositories.links_to_trips_repository import LinksToTripsRepository
...
def create_trip_link(tripId):
    conn = db_connection_handler.get_connection()
    links_repository = LinksToTripsRepository(conn)
